#
# growtsubplot.py - simulation of unconstrained growth using subplot
#
...
plt.subplot(222)
#plt.title('Prac 3.1: :Unconstrained Growth')
plt.plot(timesarray, popsarray, 'c1')
#plt.ylabel('Population')
plt.xlabel('Time')

plt.subplot(223)
#plt.title('Prac 3.1: :Unconstrained Growth')
plt.plot(timesarray, popsarray, 'k:')
plt.ylabel('Population')
plt.xlabel('Time')

plt.subplot(224)
#plt.title('Prac 3.1: :Unconstrained Growth')
plt.plot(timesarray, popsarray, 'm4')
#plt.ylabel('Population')
plt.xlabel('Time')
