#
# converter2.py - convert a list of numbers into the target unit
#
...
def main():
    ...
    print(conversion)
    convertedvalues = input("Enter value to convert: ")
    while convertedvalues:
       convertedvalue = float(convertedvalues)
       if conversion == 0:
